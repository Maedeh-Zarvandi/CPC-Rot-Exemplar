from cpc_models.VGG16_Encoder import vgg16
from cpc_models.VGG_Encoder import PreActVGG16_Encoder
...
if __name__ == "__main__":
    ...
    elif args.encoder == "vgg16":
        enc = PreActVGG16_Encoder(args, use_classifier=False)
        # print(enc)
        # enc = vgg16(args, use_classifier=False)
    else:
